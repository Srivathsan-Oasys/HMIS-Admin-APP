...
class GenderListAdapter(
    ...
    private val allPois: ArrayList<GenderResponse>
) :
    ArrayAdapter<GenderResponse>(context, layoutResource, allPois),
    Filterable {
    private var mPois: List<GenderResponse> = allPois

    override fun getCount(): Int {
        return mPois.size
    }

    override fun getItem(p0: Int): GenderResponse? {
        return mPois.get(p0)
    }
    ...
    override fun getFilter(): Filter {
        return object : Filter() {
            override fun publishResults(
                ...
                try {
                    mPois = filterResults.values as List<GenderResponse>
